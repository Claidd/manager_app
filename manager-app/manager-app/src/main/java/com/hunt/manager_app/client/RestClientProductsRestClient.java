...
//    Чтобы библиотека джексон, которая парсит джейсон строки и преобразует их в джава объекты могла понять, что у нас список товаров, а не просто список каких-то объектов.
